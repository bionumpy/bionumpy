...
def test_plain_string_matching():
    ...
    seq_array = bionumpy.encoded_array_functions.as_encoded_array(['V1-1', 'V2-1', 'V1-1*2'])
...
def test_fixedlen_regex_matching():
    ...
    sequence_array = bionumpy.encoded_array_functions.as_encoded_array(sequences, target_encoding=bnp.encodings.DNAEncoding)
